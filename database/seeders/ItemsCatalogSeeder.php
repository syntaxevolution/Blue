...
class ItemsCatalogSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $items = [
            ...
            ['key' => 'motion_sensor_array', 'post_type' => 'fort', 'name' => 'Motion Sensor Array',     'description' => 'Triggers on squirrels. And wind. And squirrels.',                    'price_barrels' => 70,  'effects' => ['stat_add' => ['security' => 4]],      'sort_order' => 100],
            ...
            ['key' => 'signal_disruptor',   'post_type' => 'fort', 'name' => 'Signal Disruptor',        'description' => 'Broadcasts elevator music on every reconnaissance frequency.',        'price_barrels' => 140,  'effects' => ['stat_add' => ['security' => 5]],       'sort_order' => 160],
            ['key' => 'counter_intel_array', 'post_type' => 'fort', 'name' => 'Counter-Intel Array',     'description' => 'Feeds spies a plausible but wrong inventory. Includes a decoy gerbil.', 'price_barrels' => 250,  'effects' => ['stat_add' => ['security' => 6]],       'sort_order' => 170],
            // Batch 3 - counter-surveillance. Security was lagging far
            // behind the stealth ladder, making base spy detection too
            // weak once stealth players reached the high-cap economy.
            ['key' => 'watchtower_relay',    'post_type' => 'fort', 'name' => 'Watchtower Relay',        'description' => 'Linked antennae and glass scopes around your base perimeter.',        'price_barrels' => 420,  'effects' => ['stat_add' => ['security' => 7]],       'sort_order' => 180],
            ['key' => 'thermal_tripnet',     'post_type' => 'fort', 'name' => 'Thermal Tripnet',         'description' => 'Heat sensors tuned for slow feet and cold nerves.',                   'price_barrels' => 700,  'effects' => ['stat_add' => ['security' => 8]],       'sort_order' => 190],
            ['key' => 'signal_triangulator', 'post_type' => 'fort', 'name' => 'Signal Triangulator',     'description' => 'Pins unfamiliar transmitters before the operator knows they leaked.', 'price_barrels' => 1400,  'effects' => ['stat_add' => ['security' => 10]],      'sort_order' => 200],
            ['key' => 'blindspot_scrubber',  'post_type' => 'fort', 'name' => 'Blindspot Scrubber',      'description' => 'Fills spy-friendly gaps with noisy perimeter telemetry.',              'price_barrels' => 6500, 'effects' => ['stat_add' => ['security' => 12]],      'sort_order' => 210],
            ['key' => 'blackbox_counterwatch', 'post_type' => 'fort', 'name' => 'Blackbox Counterwatch', 'description' => 'A buried recorder network that turns every probe into a trail.',      'price_barrels' => 65000, 'effects' => ['stat_add' => ['security' => 15]],      'sort_order' => 220],
            ...
            ['key' => 'lucky_coin',           'post_type' => 'tech', 'name' => 'Lucky Coin',          'description' => 'Tarnished. Lucky. −0.5% drill break chance.',                                       'price_barrels' => 400,  'effects' => ['break_chance_reduction_pct' => 0.005], 'sort_order' => 60],
            ['key' => 'torque_wrench',        'post_type' => 'tech', 'name' => 'Torque Wrench',       'description' => '−0.3% drill break chance. Smells faintly of diesel.',                               'price_barrels' => 600,  'effects' => ['break_chance_reduction_pct' => 0.003], 'sort_order' => 70],
            ...
            ['key' => 'reinforced_bit',       'post_type' => 'tech', 'name' => 'Reinforced Bit',      'description' => '−0.4% drill break chance. Tungsten, mostly.',                                       'price_barrels' => 900,  'effects' => ['break_chance_reduction_pct' => 0.004], 'sort_order' => 90],
            ['key' => 'field_journal',        'post_type' => 'tech', 'name' => 'Field Journal',       'description' => 'Tidy notes, tidy yields. +1 daily drill per oil field.',                            'price_barrels' => 1500,  'effects' => ['daily_drill_limit_bonus' => 1],   'sort_order' => 100],
