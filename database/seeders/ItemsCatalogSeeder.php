...
class ItemsCatalogSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $items = [
            ...
            ['key' => 'iron_resolve',      'post_type' => 'general', 'name' => 'Iron Resolve',        'description' => 'A motivational pamphlet and a cracked coffee mug. +1 daily drill per field.',                                     'price_barrels' => 700, 'effects' => ['daily_drill_limit_bonus' => 1],              'sort_order' => 30],
            ...
            ['key' => 'lucky_rabbit_foot', 'post_type' => 'general', 'name' => 'Lucky Rabbit Foot',   'description' => 'Unlucky for the rabbit. −0.3% drill break chance.',                                                              'price_barrels' => 500, 'effects' => ['break_chance_reduction_pct' => 0.003],       'sort_order' => 50],
